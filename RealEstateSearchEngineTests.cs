...
public class RealEstateSearchEngineTests
{
    ...
    public void PerformTimeAnalysis_CalculatesCorrectTimeMetrics()
    {
        ...
        var priceTrends = analysis["PriceTrends"] as Dictionary<string, float>;
        Assert.IsNotNull(priceTrends);
        ...
        Assert.AreEqual(275000, priceTrends["2025-01"], 0.01);
        // The average price for February should be 350000
        Assert.AreEqual(350000, priceTrends["2025-02"], 0.01);
    }
}
